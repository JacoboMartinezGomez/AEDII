...
public class Practica7Test {
    ...
    public void testSumideroVacio() {
        ...
        boolean result = Practica7.sumidero(gVacio, v3);
        assertFalse(result);
    }
    @Test
    public void testNoSumidero() {
        System.out.println("sumidero");
        boolean result = Practica7.sumidero(g, v3);
        assertFalse(result);
    }
    @Test
    ...
    public void testHayCaminoEntreDos() {
        ...
        boolean expResult = false;
        boolean result = Practica7.hayCaminoEntreDos(gVacio, v1, v2);
        assertEquals(expResult, result);   
    }
    ...
    public void testEsArborescencia() {
        ...
        Vertice<String> result = Practica7.esArborescencia(g);
        assertEquals(expResult, result);   
    }
    @Test
